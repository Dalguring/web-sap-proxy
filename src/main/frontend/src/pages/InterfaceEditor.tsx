...
const InterfaceEditor = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (payload.id) {
                sessionStorage.removeItem(DETAIL_CACHE_PREFIX + payload.id);
            }
                ...
                <div className="bg-white rounded border shadow-sm p-4">
                    ...
                    {(activeTab === 'import' || activeTab === 'export') && (
                        <div className="grid grid-cols-12 gap-2 text-xs font-bold text-gray-500 uppercase px-2 mb-2">
                             <div className="col-span-3">Web Field</div><div className="col-span-3">SAP Field</div><div className="col-span-2">Type</div><div className="col-span-1 text-center">Len</div><div className="col-span-2 text-blue-600">Example</div><div className="col-span-1 text-center">Del</div>
                        </div>
                    )}
